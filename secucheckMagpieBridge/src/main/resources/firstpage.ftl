...
<div class="container" style="word-wrap: break-word;">
    ...
    <ul class="nav nav-pills" style="font-size: 18px">
        ...
        <li><a data-toggle="tab" href="#tfqDisplayFormat">TaintFlowQueries display format</a></li>
    </ul>
            ...
            <div class="tab-content"
                ...
                <div id="fluentSpec" class="tab-pane fade in active">
                    ...
                    <div class="form-group" style="font-size: 18px">
                        <input type="text" id="specpath" name="specPath" spellcheck="false" class="form-control"
                               placeholder="Absolute path to Directory containing compiled Jar" size=50>
                    </div>

                </div>
                <div id="tfqDisplayFormat" class="tab-pane fade" style="font-size: 18px">
                    <label class="radio-inline" style="font-size: 18px">
                        <input type="radio" id="displayAsTaintFlowQueries" value="displayAsTaintFlowQueries"
                               name="displayFormat" checked>Display as TaintFlowQueries
                    </label>
                    <label class="radio-inline" style="font-size: 18px">
                        <input type="radio" id="displayAsSpecFile" value="displayAsSpecFile" name="displayFormat">Display
                        as
                        Specification file
                    </label>
                </div>
                <button style="margin-top:1em;margin-right:1em;padding:0.5em 1em 0.5em 1em;" type="submit"
                        class="btn btn-default">Submit
                </button>
                <button style="margin-top:1em;padding:0.5em 1em 0.5em 1em;" type="reset" class="btn btn-default">Reset
                </button>
            </div>
        </form>
    </div>
