package de.fraunhofer.iem.secucheck.InternalFluentTQL.Specifications.FuentTQLRepositories.Sinks;
...
public class ServletSinks {
    ...
    @InFlowParam(parameterID = {0})
    public static final Method sink2 = new MethodSelector("java.io.PrintWriter: void print(java.lang.String)");

    @InFlowParam(parameterID = {0})
    public static final Method sink3 = new MethodSelector("java.io.PrintWriter: void println(java.lang.String)");
