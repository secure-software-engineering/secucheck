...
public class SecuCheckMapieBridgeResult implements AnalysisResult {
	...
	@Override public Kind kind() { return this.kind; }
	@Override public Position position() { return position; }
	@Override public Iterable<Pair<Position, String>> related() { return related; }
	@Override public DiagnosticSeverity severity() { return severity; }
	@Override public Pair<Position, String> repair() { return repair; }
	@Override public String code() { return code; }
	@Override public String toString(boolean useMarkdown) { return toString(); }
	
	public void setKind(Kind kind) { this.kind = kind;}
	public void setPosition(Position position) { this.position = position;}
	public void setMessage(String message) { this.message = message; }
	public void setRelated(Iterable<Pair<Position, String>> related) { this.related = related; }
	public void setSeverity(DiagnosticSeverity severity) { this.severity = severity; }
	public void setRepair(Pair<Position, String> repair) { this.repair = repair; }
