...
public class NullInFromMethodCaseSpec implements FluentTQLUserInterface {
    @OutFlowReturnValue
    ...
    public List<FluentTQLSpecification> getFluentTQLSpecification() {
        TaintFlowQuery myTF = new TaintFlowQueryBuilder("id8")
                .from(null)       //Fixme: This is the problem/error
                .to(sink)
