package secucheck.secucheckCommonsUtility.SecuCheckSARIFGenerator;


import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import secucheck.secucheckCommonsUtility.ApplicationPropertiesUtility;
import secucheck.secucheckCommonsUtility.FluentTQLUtility;
import secucheck.InternalFluentTQL.dsl.CONSTANTS.LOCATION;
import secucheck.InternalFluentTQL.fluentInterface.Query.TaintFlowQuery;
import secucheck.secucheckCommonsUtility.SecuCheckSARIFRepresentations.Sarif;
import secucheck.secucheckCommonsUtility.SecuCheckSARIFRepresentations.run.Run;
import secucheck.secucheckCommonsUtility.SecuCheckSARIFRepresentations.run.result.Result;
...
import secucheck.secucheckCommonsUtility.SecuCheckSARIFRepresentations.run.tool.Tool;
import secucheck.secucheckCommonsUtility.SecuCheckSARIFRepresentations.run.tool.toolProperties.ToolProperties;
...
import secucheck.analysis.result.*;
import secucheck.fluentTQL2English.BriefFluentTQL2Eng;
import secucheck.fluentTQL2English.FluentTQL2English;
