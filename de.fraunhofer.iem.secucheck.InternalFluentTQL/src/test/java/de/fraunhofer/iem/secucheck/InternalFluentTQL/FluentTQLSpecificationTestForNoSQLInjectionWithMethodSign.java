...
public class FluentTQLSpecificationTestForNoSQLInjectionWithMethodSign implements FluentTQLUserInterface {
	public List<FluentTQLSpecification> getFluentTQLSpecification() {
		...
		MethodSignature source1signature = new MethodSignatureConfigurator("catalog.NoSQLInjection.CWE943.NoSQLInjectionWithTwoSources").
				returns("java.lang.String").named("getUserName").accepts("").configure();
        ...
        MethodSignature source2signature = new MethodSignatureConfigurator("catalog.NoSQLInjection.CWE943.NoSQLInjectionWithTwoSources").
				returns("java.lang.String").named("getOldPassword").accepts("").configure();
        Method source2 = new MethodConfigurator(source2signature)
                .out().returnValue().configure();

        //Third source that takes new password from the user.
        MethodSignature source3signature = new MethodSignatureConfigurator("catalog.NoSQLInjection.CWE943.NoSQLInjectionWithTwoSources").
				returns("java.lang.String").named("getNewPassword").accepts("").configure();
        Method source3 = new MethodConfigurator(source3signature)
                .out().returnValue().configure();

        //sanitizeForMongoDB is user defined simple sanitizer for MongoDB.
        MethodSignature sanitizersignature = new MethodSignatureConfigurator("catalog.NoSQLInjection.CWE943.NoSQLInjectionWithTwoSources").
				returns("java.lang.String").named("sanitizeForMongoDB").accepts("java.lang.String").configure();
        ...
        MethodSignature requiredPropagator1signature = new MethodSignatureConfigurator("com.mongodb.BasicDBObject").
				returns("com.mongodb.BasicDBObject").named("put").accepts("java.lang.String, java.lang.String").configure();
        ...
        //If the data flow goes through this method before sanitizer then there will be a security vulnerability.
        MethodSignature requiredPropagator2signature = new MethodSignatureConfigurator("com.mongodb.BasicDBObject").
				returns("com.mongodb.BasicDBObject").named("put").accepts("java.lang.String, com.mongodb.BasicDBObject").configure();
        ...
        MethodSignature sinksignature = new MethodSignatureConfigurator("com.mongodb.client.MongoCollection").
				returns("com.mongodb.client.FindIterable").named("updateOne").accepts("com.mongodb.BasicDBObject, com.mongodb.BasicDBObject").configure();
