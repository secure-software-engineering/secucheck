package secucheck.secucheckCommonsUtility.SecuCheckMagpieBridge.SecucheckHttpServer;

import java.io.IOException;
import java.net.InetSocketAddress;

import com.sun.net.httpserver.HttpServer;
import secucheck.secucheckCommonsUtility.SecuCheckMagpieBridge.SecucheckHttpServer.handlers.ConfigSubmissionHandler;
import secucheck.secucheckCommonsUtility.SecuCheckMagpieBridge.SecucheckHttpServer.handlers.SecuMainHandler;
import secucheck.secucheckCommonsUtility.SecuCheckMagpieBridge.SecucheckHttpServer.handlers.SpecPathResponseHandler;
